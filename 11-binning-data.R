...
students.dummy = dummy.data.frame(students, sep = ".") #asigna valores num a las categoricas
names(students.dummy)

#si solo quiero convertir una columna

dummy(students$State,sep = ".") 

#un subconjunto de variables especifico
